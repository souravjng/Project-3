      ...
      <Divbottom>
        <Formik
          ...
          <Form>
            ...
            <Fielddiv><Fieldd autoComplete="off" type="text" name="subject" id="subject" placeholder="Subject" /><ErrrorMessage name="subject" component="div" className="error" />
            </Fielddiv>
            <Fielddiv><Fieldd autoComplete="off" type="text" name="about" id="about" placeholder="About" /><ErrrorMessage name="about" component="div" className="error" />
            </Fielddiv>
            <Fielddiv><Fieldd autoComplete="off" type="text" name="description" id="description" placeholder="Description" /><ErrrorMessage name="description" component="div" className="error" />
            </Fielddiv>
            <Fielddiv><Fieldd autoComplete="off" type="text" name="coordinates" id="coordinates" placeholder="Click to choose Location" value={coordinates} />
            </Fielddiv>

            <Fielddiv2 style={{ borderTop: '1px solid #80808061' }}><Fieldd type="file" name="image1" id="image1" placeholder="Image 1" style={{ border: 'none', marginTop: '20px' }} /><ErrrorMessage name="image1" component="div" className="error" />
            </Fielddiv2>
